...
if ($jenis_pangan == "Ubi jalar"){
   $data = mysqli_query($koneksi, "SELECT * FROM db_cilacap WHERE Jenis_Tanaman = 'Ubi Jalar'");
   $dataakurasi = mysqli_query($koneksi, "SELECT * FROM db_cilacap WHERE Jenis_Tanaman = 'Ubi Jalar'");
                                
    }

elseif ($jenis_pangan == 'Padi') {
     $data = mysqli_query($koneksi, "SELECT * FROM db_cilacap WHERE Jenis_Tanaman = 'Padi'");
     $dataakurasi = mysqli_query($koneksi, "SELECT * FROM db_cilacap WHERE Jenis_Tanaman = 'Padi'");

                                
    }
elseif ($jenis_pangan == "jagung") {
      $data = mysqli_query($koneksi, "SELECT * FROM db_cilacap WHERE Jenis_Tanaman = 'Jagung'");
      $dataakurasi = mysqli_query($koneksi, "SELECT * FROM db_cilacap WHERE Jenis_Tanaman = 'Jagung'");
        }    
...
<head>
    ...
    <script src="js/buatpdfcilacap.js"></script>
...
<?php include 'js/file.php';?>
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                         <a target="_blank" rel="nofollow" href="data_cilacap.php">&rarr; Lihat Data Cilacap</a>

                        <button id="downloadcilacap" class="btn shadow-sm btn-danger text-light font-weight-bold btn-sm text-left">Export PDF</button>
            </div>
        <!--<div class="col-lg-12">
            <div class="card shadow mb-4">
             ...
             <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold  text-primary">Data Tables <?php echo "$jenis_pangan"; ?> Kabupaten Cilacap</h6>
                        </div>
                        <div class="card-body">
             ...
             <div class="card shadow mb-4">
                        <div class="card-header">
                            <h6 class="m-0 font-weight-bold  text-primary">Data Akurasi RMSE <?php echo "$jenis_pangan"; ?> Kabupaten Cilacap</h6>
