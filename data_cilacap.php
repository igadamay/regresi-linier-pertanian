            ...
            <div class="container-fluid">
                   ...
                   <!-- isi -->
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h4 class="h4 mb-0 text-gray-800">Data Pangan Kabupaten Cilacap</h4>
                    </div>
                        ...
                        <div class="col-lg-6 mb-4">
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                 ...
                                 <div class="col mr-2">
                                 <form class="user"  method="post" action="prediksi_cilacap.php">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <?php 
                                 $no = 1;
                                 $data = mysqli_query($koneksi,"select * from db_cilacap");
                            ...
                            <td>
                                <a href="delete/hapus_cilacap.php?No=<?php echo $d['No']; ?>">DELETE</a>
                            </td>
                            </tr>
                              <?php 
                                    }
