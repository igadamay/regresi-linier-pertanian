...
if ($jenis_pangan == "Ubi jalar"){
   $data = mysqli_query($koneksi, "SELECT * FROM db_grobogan WHERE Jenis_Tanaman = 'Ubi Jalar'");
                                
	}

elseif ($jenis_pangan == 'Padi') {
     $data = mysqli_query($koneksi, "SELECT * FROM db_grobogan WHERE Jenis_Tanaman = 'Padi'");
                                
    }
elseif ($jenis_pangan == "jagung") {
      $data = mysqli_query($koneksi, "SELECT * FROM db_grobogan WHERE Jenis_Tanaman = 'Jagung'");
        }    
...
<head>
    ...
    <script src="js/buatpdfgrobogan.js"></script>
</head>
...
<?php include 'js/file.php';?>
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                         <a target="_blank" rel="nofollow" href="data_grobogan.php">&rarr; Lihat Data Grobogan</a>
                         <button id="downloadgrobogan" class="btn shadow-sm btn-primary text-light font-weight-bold btn-sm text-left">Export PDF</button>
            </div>
             ...
             <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold  text-primary">Data Tables <?php echo "$jenis_pangan"; ?> Kabupaten Grobogan</h6>
                     ...
                     <div class="col-xl-4 col-lg-5">
                            <div class="card shadow mb-4" id="buatpdfgrobogan">
